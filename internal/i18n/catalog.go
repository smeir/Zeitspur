...
func NewCatalog() Catalog {
	return Catalog{
		German: {
			...
			"ColorThemeHint":          "Farbpalette der Oberfläche.",
			"ThemeTeal":               "Teal",
			"ThemeAurora":             "Aurora (Indigo)",
			...
			"CopilotProjReached":       "Limit erreicht",
			"CopilotProjOk":            "reicht bis Reset",
			"CopilotProjOn":            "Limit am {{.Date}}",
		...
		English: {
			...
			"ColorThemeHint":          "Color palette of the interface.",
			"ThemeTeal":               "Teal",
			"ThemeAurora":             "Aurora (indigo)",
			"ServerSettings":          "Server",
			...
			"CopilotProjReached":       "Limit reached",
			"CopilotProjOk":            "lasts until reset",
			"CopilotProjOn":            "limit on {{.Date}}",
